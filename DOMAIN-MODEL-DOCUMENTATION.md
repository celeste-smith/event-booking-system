...
| Admin *(inherits from User)*         | Inherits User attributes        | manageUsers(), manageEvents(), viewReports()  | Created by Admin, linked to multiple Bookings. Inherits from User; manages Events and Venues                        |
